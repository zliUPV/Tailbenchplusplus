...
for ((QPS_total=500; QPS_total<15001; QPS_total=QPS_total)); do
    QPS=$(echo "scale=0; ${QPS_total}/${CLIENTS}" | bc -l)
    
    echo EXP SPECJBB -- CLIENTS: ${CLIENTS} CLIENT_THREADS: ${N_THREADS} OVERALL_QPS: ${QPS_total} QPS_X_CLIENT: ${QPS}
