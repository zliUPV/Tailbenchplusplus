/*<std-header orig-src='shore'>
 ...
 $Id: w_input.cpp,v 1.13.2.5 2010/03/19 22:17:19 nhall Exp $
...
{
    /*  start, sgned,  leadz,  new_hex,new_oct,new_dec,is_hex, is_oct, is_dec, end2 */
/* zero */
...
/* c1_7 */
    ...
    {  new_dec,new_dec,new_oct,is_hex, is_oct, is_dec, is_hex, is_oct, is_dec, error},
/* c8_9 */
    {  new_dec,new_dec,new_dec,is_hex, end2,    is_dec, is_hex, is_oct, is_dec,error },
    {  new_dec,new_dec,new_dec,is_hex, end2,    is_dec, is_hex, is_oct, is_dec,error },
/* ca-f */
    {  error,error,new_hex,is_hex, end2,    end2,    is_hex, end2,    end2,   error },
    {  error,error,new_hex,is_hex, end2,    end2,    is_hex, end2,    end2,   error },
    {  error,error,new_hex,is_hex, end2,    end2,    is_hex, end2,    end2,   error },
    {  error,error,new_hex,is_hex, end2,    end2,    is_hex, end2,    end2,   error },
    {  error,error,new_hex,is_hex, end2,    end2,    is_hex, end2,    end2,   error },
    {  error,error,new_hex,is_hex, end2,    end2,    is_hex, end2,    end2,   error },
/* exx */
    {  error,  error,  new_hex,end2,    end2,    end2,    end2,    end2,    end2,   error },
/* JJJJ */
    {  error,  error,  end2,    no_hex, end2,    end2,    end2,    end2,    end2,   error },
/* EOF, eofile */
    {  error,  error,  end2,    no_hex, end2,    end2,    end2,    end2,    end2,   error },
/* white */
    {  start,  error,  end2,    end2,    end2,    end2,    end2,    end2,    end2,   error },
/* sign */
    {  sgned,  error,  end2,    no_hex, end2,    end2,    end2,    end2,    end2,   error }, 
};
...
/* ca-f */
    ...
    {  is_hex,    is_hex, is_hex, is_hex, error,error,is_hex, error, error, error },
/* exx */
    {  error,  error, new_hex, end2,    error,error,  end2,   error, error, error },
/* JJJJ */
    {  error,  error,  end2,    no_hex, error,error,  end2,   error, error, error }, 
/* EOF, eofile */
    {  error,  error,  end2,    no_hex, error,error,  end2,   error, error, error }, 
/* white */
    {  start,  error,  end2,    no_hex, error,error,  end2,   error, error, error }, 
/* sign */
    {  sgned,  error,  end2,    no_hex, error,error,  end2,   error, error, error }, 
};
...
/* c1_7 */
    ...
    {  is_oct,is_oct, is_oct, error, error, error, error, is_oct, error,error },
/* c8_9 */
    {  end2,   error,  end2,    error, error, error, error, end2,   error,    error },
    {  end2,   error,  end2,    error, error, error, error, end2,   error,    error },
/* ca-f */
    {  end2,   error,  end2,    error, error,error,  error, end2,   error, error },
    {  end2,   error,  end2,    error, error,error,  error, end2,   error, error },
...
/* exx */
    {  error, error,  new_hex,end2,   error,error,  end2,   error, error, error },
/* JJJJ */
    {  error, error, end2,     error, error,error,  error, end2,      error, error }, 
/* EOF, eofile */
    {  error, error, end2,     error, error,error,  error, end2,      error, error }, 
/* white */
    {  start, error, end2,     error, error,error,  error, end2,      error, error }, 
/* sign */
    {  sgned, error, end2,     error, error,error,  error, end2,      error, error }, 
};
...
/* c1_7 */
    ...
    {  is_dec,is_dec, is_dec, error, error, error, error, error, is_dec,error },
/* c8_9 */
    {  is_dec,is_dec, end2,    error, error, error, error, end2,   is_dec,error },
    {  is_dec,is_dec, end2,    error, error, error, error, end2,   is_dec,error },
/* ca-f */
    {  end2,   error,  end2,    error, error,error,  error, end2,   error, error },
    {  end2,   error,  end2,    error, error,error,  error, end2,   error, error },
...
/* exx */
    {  error, error, new_hex, end2,   error,error,  end2,   error, error, error },
/* JJJJ */
    {  error, error, end2,     error, error,error,  error, error, end2,   error }, 
/* EOF, eofile */
    {  error, error, end2,     error, error,error,  error, error, end2,   error }, 
/* white */
    {  start, error, end2,     error, error,error,  error, error, end2,   error }, 
/* sign */
    {  sgned, error, end2,     error, error,error,  error, error, end2,   error }, 
};
...
) 
{
    ...
    switch(s) {
        ...
        if(base && (base != 4)) {
            /* consider this the end2 of the string */
            IOS_BACK(i, ch);
            s = end2;
            break;
        }
