...
# LAUNCH THE SERVER
TBENCH_SERVER_PORT=${PORT} TBENCH_MAXREQS=${MAXREQS} TBENCH_WARMUPREQS=${WARMUPREQS} TBENCH_NCLIENTS=${N_CLIENTS} taskset -c 5,29 ${DIR}/xapian_networked_server -n ${NUM_THREADS} -d ${DATA_ROOT}/xapian/wiki &
echo $! > server.pid
